...
disp.image(image)
"""
image = Image.open("/home/lucas/Python_ST7735/examples/cat.jpg")
...
"""
#draw.line((0, 0, width, height), fill=(255, 255, 255))
#draw.line((0, height, width, 0), fill=(255, 255, 255))
"""
...
while True:
    if button1.is_pressed:
        ...
        draw.line((0, 0, width, height), fill=(r, g, b))
        draw.line((0, height, width, 0), fill=(b, r, g))
        disp.image(image)
        time.sleep(0.05)
    if button2.is_pressed:
        ...
        draw.text(location, sample, font = font, anchor = "mm", stroke_width = 1, stroke_fill = (255, 255, 255),fill=(r, g, b))
        disp.image(image)
        time.sleep(0.05)
    else:
